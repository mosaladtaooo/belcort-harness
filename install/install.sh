...
PLUGIN_SRC="$REPO_ROOT/plugins/harness"
cp "$PLUGIN_SRC/skills/harness/SKILL.md" "$CLAUDE_DIR/skills/harness/SKILL.md"
cp -r "$PLUGIN_SRC/commands" "$CLAUDE_DIR/commands-harness"
...
cp "$PLUGIN_SRC/agents/planner.md" "$CLAUDE_DIR/agents/planner.md"
cp "$PLUGIN_SRC/agents/generator.md" "$CLAUDE_DIR/agents/generator.md"
cp "$PLUGIN_SRC/agents/evaluator.md" "$CLAUDE_DIR/agents/evaluator.md"
echo "  installed: agents/{planner,generator,evaluator}.md"

cp "$PLUGIN_SRC/hooks/session-start.sh" "$CLAUDE_DIR/hooks/session-start.sh"
cp "$PLUGIN_SRC/hooks/pre-tool-use.sh" "$CLAUDE_DIR/hooks/pre-tool-use.sh"
...
echo "  $PLUGIN_SRC/CLAUDE.md.snippet.txt"
echo ""
